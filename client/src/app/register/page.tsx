...
const registerUser = async (data: RegisterFormInputs) => {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_USER_API_URL}/api/users/register`,
    {
      headers: {
...
export default function Register() {
  ...
  useEffect(() => {
    if (authState.isLoggedIn) router.push("/");
                ...
                <div className="inline-flex items-center justify-center absolute left-0 top-0 h-full w-10 text-gray-400">
                  <span>
                    <svg
                      ...
                      stroke="currentColor"
                    >
                      <path d="M12 15v2m0 0v2m0-2h2m-2 0H9m-2 0a3 3 0 110-6 3 3 0 010 6zM3 13v6a2 2 0 002 2h14a2 2 0 002-2v-6m-4 0h-4m-4 0H7" />
                    </svg>
                  </span>
                </div>
                <input
